...
public class KitchenMain extends JFrame {
	...
	public KitchenMain() throws Exception {
		...
		final Font ft1 = new Font("THE외계인설명서", Font.BOLD, 20);
		final Font ft2 = new Font("THE외계인설명서", Font.PLAIN, 16);
		...
		lblNewLabel_1.setFont(new Font("THE외계인설명서", Font.PLAIN, 11));
				...
				try {
					...
					for(Menu t : checkList) {
						if(selected.equals(t.getCategory())) {
							...
							jbMinus.setBackground(new Color(240, 240, 240));
							...
							jbPlus.setBackground(new Color(240, 240, 240));
							
							jbCancel.setFont(ft1);
							jbCancel.addActionListener(ev->{
								JOptionPane.showMessageDialog(null, "기능 준비중");
							});
							jbCancel.setBackground(new Color(240, 240, 240));
