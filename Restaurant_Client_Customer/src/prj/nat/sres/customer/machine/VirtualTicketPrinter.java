...
public class VirtualTicketPrinter extends JDialog {
	...
	public static void main(String[] args) {
		try {
			VirtualTicketPrinter vt = new VirtualTicketPrinter("카테고리", "메뉴 이름", 10000, "오늘도 한끼", 1);
	...
	public VirtualTicketPrinter(String category, String menuName, int price, String kioskName, int kioskNo) {
		...
		setTitle("Ticket");
		setFont(new Font("THE외계인설명서", Font.PLAIN, 12));
		setBounds(100, 100, 216, 216);
		getContentPane().setLayout(new BorderLayout());
		contentPanel.setBackground(new Color(238, 195, 153));
		...
		contentPanel.setLayout(null);
		{
			...
			lblCategory.setFont(new Font("THE외계인설명서", Font.PLAIN, 18));
		...
		}
		{
			...
			lblmenuName.setFont(new Font("THE외계인설명서", Font.PLAIN, 25));
		...
		}
		{
			...
			lblPrice.setFont(new Font("THE외계인설명서", Font.PLAIN, 15));
		...
		}
		{
			...
			lblPrintedDate.setFont(new Font("THE외계인설명서", Font.PLAIN, 15));
		...
		}
		{
			...
			lblKioskName.setFont(new Font("THE외계인설명서", Font.PLAIN, 12));
			contentPanel.add(lblKioskName);
		}
		{
			JLabel lblPaymentMethod = new JLabel("현금");
			lblPaymentMethod.setBounds(125, 134, 64, 17);
			lblPaymentMethod.setFont(new Font("THE외계인설명서", Font.PLAIN, 12));
